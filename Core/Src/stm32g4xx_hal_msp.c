...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PC5     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOC, M1_TX_Pin|M1_RX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PB3     ------> USART2_TX
    */
    HAL_GPIO_DeInit(M_RX_GPIO_Port, M_RX_Pin);

    HAL_GPIO_DeInit(M_TX_GPIO_Port, M_TX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB9     ------> USART3_TX
    */
    HAL_GPIO_DeInit(GPIOB, FT_RX_Pin|FT_TX_Pin);
